...
Actor::~Actor() {};
    ...
    // void Actor::parseAnimation(pugi::xml_node &nodeAnimation, pugi::xml_node &nodeMotion, Bone *_bone, const std::string &animationName) {
    ...
    #if MY_ACTOR_TEST
    void Actor::PushRender(Render *_render)
    {
        render = _render;
    }
