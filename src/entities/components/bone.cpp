...
{
    _parent.children.emplace_back(Bone(_name, &_parent));
    return _parent.children[_parent.children.size() - 1].parseBone(node, _parent.children[_parent.children.size() - 1]);
};
