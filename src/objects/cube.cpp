...
void Cube::initializeGeometry()
{
    ...
    // немного запутался, но работает
    std::vector<Vertex> vertices = {
        // передняя грань (начало: ближний сверху справа)
        {{1, 1, 1}, {0.5, 2.0f / 3.0f}},  {{-1, 1, 1}, {0.25f, 2.0f / 3.0f}},  {{-1, -1, 1}, {0.25f, 1.0f / 3.0f}},  {{1, -1, 1}, {0.5, 1.0f / 3.0f}},
        // задняя грань (начало: дальний сверху справа)
        {{1, 1, -1}, {0.75f, 2.0f / 3.0f}}, {{-1, 1, -1}, {1.0f, 2.0f / 3.0f}}, {{-1, -1, -1}, {1.0f, 1.0f / 3.0f}}, {{1, -1, -1}, {0.75f, 1.0f / 3.0f}},

        // левая грань (начало: дальний сверху слева)
        {{-1, 1, 1}, {0.25f, 2.0f / 3.0f}}, {{-1, 1, -1}, {0.0, 2.0f / 3.0f}}, {{-1, -1, -1}, {0.0, 1.0f / 3.0f}}, {{-1, -1, 1}, {0.25, 1.0f / 3.0f}},
        // правая грань (начало: ближний сверху справа)
        {{1, 1, 1}, {0.5f, 2.0f / 3.0f}},  {{1, 1, -1}, {0.75f, 2.0f / 3.0f}},  {{1, -1, -1}, {0.75f, 1.0f / 3.0f}},  {{1, -1, 1}, {0.5f, 1.0f / 3.0f}},

        // нижняя грань (начало: ближний снизу слева)
        {{-1, -1, 1}, {0.25f, 1.0f / 3.0f}}, {{1, -1, 1}, {0.5f, 1.0f / 3.0f}}, {{1, -1, -1}, {0.5f, 0.0f}},  {{-1, -1, -1}, {0.25f, 0.0f}},
        // верхняя грань (начало: ближний сверху слева)
        {{-1, 1, 1}, {0.25f, 2.0f / 3.0f}}, {{1, 1, 1}, {0.5f, 2.0f / 3.0f}},   {{1, 1, -1}, {0.5f, 1.0f}},   {{-1, 1, -1}, {0.25f, 1.0f}},
    };
